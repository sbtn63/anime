...
from schemas.user import UserSchema, UserRatedAnimeShema
...
@rated_anime.post('/')
async def user_rated_anime(rated_data : UserRatedAnimeShema, current_user : UserSchema = Depends(get_current_user)):
